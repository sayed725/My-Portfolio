...
<section className="mb-8">
  ...
  <div className="mb-4">
    ...
    <ul className="list-disc pl-6 space-y-2">
      ...
      <li>Sort by Popularity (based on Upvote-Downvote difference).</li>
  ...
  <div className="mb-4">
    ...
    <ul className="list-disc pl-6 space-y-2">
      <li>Displays post details such as title, author, tags, description, and comments.</li>
      <li>Comment, Upvote, Downvote, and Share functionality.</li>
      <li>Any logged-in user can vote, comment, and share posts.</li>
    </ul>
  </div>
  <div className="mb-4">
    <h3 className="text-xl mb-2 font-semibold">Membership Page</h3>
    <ul className="list-disc pl-6 space-y-2">
      <li>Allows users to pay to become members and post more than 5 posts.</li>
      <li>Added Stripe Payment Method to facilitate membership purchases.</li>
    </ul>
  </div>
  <div className="mb-4">
...
<section className="mb-8">
  ...
  <div className="mb-4">
    ...
    <ul className="list-disc pl-6 space-y-2">
      <li>My Profile: Displays user's name, email, badges, and recent posts.</li>
      <li>Add Post: Post content with tags, upvotes, and downvotes.</li>
      <li>My Posts: View and manage (delete, comment, report) user posts.</li>
    </ul>
  </div>
  <div className="mb-4">
    <h3 className="text-xl mb-2 font-semibold">Membership Perks</h3>
    <ul className="list-disc pl-6 space-y-2">
      <li>Gold Badge for members with an increased posting limit beyond 5 posts.</li>
    </ul>
  </div>
</section>
    ...
    <ul className="list-disc pl-6 space-y-2">
      <li>
        ...
        <ul className="list-disc pl-6">
          <li>Displays site stats (posts, users, comments) and a pie chart.</li>
      ...
      <li>
        ...
        <ul className="list-disc pl-6">
          ...
          <li>Take actions such as deleting comments or banning users.</li>
        </ul>
      </li>
      <li>
        <strong>Announcements:</strong>
        <ul className="list-disc pl-6">
          <li>Create and manage announcements visible to all users.</li>
        </ul>
      </li>
    </ul>
  </div>
...
<section className="mb-8">
  ...
  <ul className="list-disc pl-6 space-y-2">
    ...
    <li>Firebase and MongoDB credentials secured with environment variables.</li>
    ...
    <li>Pagination in all tables and posts.</li>
          ...
          <div className="mt-6 flex gap-4">
            ...
            <a   href="https://github.com/sayed725/PostPad-Client"
                    target="_blank"
                    rel="noopener noreferrer"
